---
description: >-
  This page describes how a Program User or Advanced User should inform
...
* This is caused by a slight time delay between the authentication codes being generated by Google and recognised by gitlab.  
...
* You can copy screen shots directly in the description field.
* The 'preview' screen shows how the issue will actually appear. 

![](../.gitbook/assets/image%20%283%29.png)

* If you raise an issue you will automatically be informed when the issue has been commented on or resolved.
...
![Example of a issues board being filtered by the TBN label](../.gitbook/assets/image%20%2885%29.png)
