...
- `playwright-a11y@preignition.org` - user signed in with access to `accessible data` team and edit rights on `survey habits` and access rights to `admin` customer
