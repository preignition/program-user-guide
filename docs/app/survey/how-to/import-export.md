...
1. In the survey's **Import/Export** settings page, click the **Export Survey Definition** button.
    ...
    <figure>
      <img src="./assets/import-export/step-1-export-survey-definition.png" alt="Click the Export Survey Definition button">
...
1. Select the target language for the translation (e.g., Arabic).
    ...
    <figure>
      <img src="./assets/import-export/step-1-select-language-for-export.png" alt="Select the target language">
...
1. Confirm your selection by clicking **Create the Export**. The platform will generate a JSON file containing your survey structure ready for translation.
    ...
    <figure>
      <img src="./assets/import-export/step-1-create-export.png" alt="Create the Export">
      <figcaption>Create the Export</figcaption>
    </figure>

## Step 2: Translate the content

The exported file is in JSON format. (For more context on this data format, see our explanation of [What is JSON?](../explanation/what-is-json.md)). You can edit this file to provide translations using either a plain text editor or an online JSON editor.

<figure>
  <img src="./assets/import-export/step-2-translated-file.png" alt="Translating the exported file">
...
1. Navigate back to the **Import/Export** settings and click the **Import Survey Definition** button.
    ...
    <figure>
      <img src="./assets/import-export/step-3-import-translated-form.png" alt="Click Import Survey Definition">
...
1. Click **Upload File...** to select your translated JSON file.
    ...
    <figure>
      <img src="./assets/import-export/step-3-upload-translated-file.png" alt="Upload the translated file">
...
1. Confirm the language that corresponds to the content in the file (e.g., Arabic).
    ...
    <figure>
      <img src="./assets/import-export/step-3-select-language-for-import.png" alt="Select language for import">
...
1. Review the details in the import dialog and confirm the action to update your survey with the translated text.
    ...
    <figure>
      <img src="./assets/import-export/step-3-import-survey-dialog.png" alt="Confirm the import survey dialog">
