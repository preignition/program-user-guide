...
| :--- | :--- | :--- | :--- |
| **Visibility Mode** | Entire Fields (questions, sections, or pages) | Accessibility Modes | Providing alternative versions of questions. |
| **CSS Classes** | Inline Content within a field (markdown text or label) | Accessibility Modes | Minor text adjustments within a single field. |
| **Logical Expressions** | Entire Fields (questions, sections, or pages) | Previous Answers | Personalizing the path through the survey (Skip logic). |
